...
#define IC_INFO(lmps, hcir) \
	...
	.lmp_subver = (lmps), \
	.hci_rev = (hcir)
#define IC_INFO_4(lmps, hcir, hciv, bus) \
	.match_flags = IC_MATCH_FL_LMPSUBV | IC_MATCH_FL_HCIREV | \
...
static const struct id_table ic_id_table[] = {
	...
	/* 8761A */
	{ IC_INFO_4(RTL_ROM_LMP_8761A, 0xa, 0x6, HCI_USB),
	  .config_needed = false,
	  .has_rom_version = true,
	...
	/* 8761B */
	{ IC_INFO_4(RTL_ROM_LMP_8761A, 0xb, 0xa, HCI_UART),
	  .config_needed = false,
	  .has_rom_version = true,
	...
	/* 8761BU */
	{ IC_INFO_4(RTL_ROM_LMP_8761A, 0xb, 0xa, HCI_USB),
	  .config_needed = false,
	  .has_rom_version = true,
